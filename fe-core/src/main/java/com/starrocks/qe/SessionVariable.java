...
public class SessionVariable implements Serializable, Writable, Cloneable {
    ...
    public static final String ENABLE_SMART_DISPATCH = "enable_smart_dispatch";
    public static final String ENABLE_SMART_DISPATCH_MODEL = "enable_smart_dispatch_model";
    public static final String SMART_DISPATCH_TRAINING_PATH = "smart_dispatch_training_path";
    public static final String SMART_DISPATCH_CPU_MODEL_PATH = "smart_dispatch_cpu_model_path";
    public static final String SMART_DISPATCH_MEM_MODEL_PATH = "smart_dispatch_mem_model_path";
    public static final String SMART_DISPATCH_TIME_MODEL_PATH = "smart_dispatch_time_model_path";
    public static final String SMART_DISPATCH_PYTHON_EXEC = "smart_dispatch_python_exec";
    public static final String ENABLE_SMART_DISPATCH_SHORT_TASK = "enable_smart_dispatch_short_task";
    ...
    @VariableMgr.VarAttr(name = ENABLE_SMART_DISPATCH)
    private boolean enableSmartDispatch = false;
    @VariableMgr.VarAttr(name = ENABLE_SMART_DISPATCH_MODEL)
    private boolean enableSmartDispatchModel = false;
    @VariableMgr.VarAttr(name = SMART_DISPATCH_TRAINING_PATH)
    private String smartDispatchTrainingPath = "";
    @VariableMgr.VarAttr(name = SMART_DISPATCH_CPU_MODEL_PATH)
    private String smartDispatchCpuModelPath = "";
    @VariableMgr.VarAttr(name = SMART_DISPATCH_MEM_MODEL_PATH)
    private String smartDispatchMemModelPath = "";
    @VariableMgr.VarAttr(name = SMART_DISPATCH_TIME_MODEL_PATH)
    private String smartDispatchTimeModelPath = "";
    @VariableMgr.VarAttr(name = SMART_DISPATCH_PYTHON_EXEC)
    private String smartDispatchPythonExec = "python3";
    @VariableMgr.VarAttr(name = ENABLE_SMART_DISPATCH_SHORT_TASK)
    private boolean enableSmartDispatchShortTask = true;
    ...
    public boolean isEnableSmartDispatch() {
        return enableSmartDispatch;
    }

    public void setEnableSmartDispatch(boolean enableSmartDispatch) {
        this.enableSmartDispatch = enableSmartDispatch;
    }

    public boolean isEnableSmartDispatchModel() {
        return enableSmartDispatchModel;
    }

    public void setEnableSmartDispatchModel(boolean enableSmartDispatchModel) {
        this.enableSmartDispatchModel = enableSmartDispatchModel;
    }

    public String getSmartDispatchTrainingPath() {
        return smartDispatchTrainingPath;
    }

    public void setSmartDispatchTrainingPath(String smartDispatchTrainingPath) {
        this.smartDispatchTrainingPath = smartDispatchTrainingPath;
    }

    public String getSmartDispatchCpuModelPath() {
        return smartDispatchCpuModelPath;
    }

    public void setSmartDispatchCpuModelPath(String smartDispatchCpuModelPath) {
        this.smartDispatchCpuModelPath = smartDispatchCpuModelPath;
    }

    public String getSmartDispatchMemModelPath() {
        return smartDispatchMemModelPath;
    }

    public void setSmartDispatchMemModelPath(String smartDispatchMemModelPath) {
        this.smartDispatchMemModelPath = smartDispatchMemModelPath;
    }

    public String getSmartDispatchTimeModelPath() {
        return smartDispatchTimeModelPath;
    }

    public void setSmartDispatchTimeModelPath(String smartDispatchTimeModelPath) {
        this.smartDispatchTimeModelPath = smartDispatchTimeModelPath;
    }

    public String getSmartDispatchPythonExec() {
        return smartDispatchPythonExec;
    }

    public void setSmartDispatchPythonExec(String smartDispatchPythonExec) {
        this.smartDispatchPythonExec = smartDispatchPythonExec;
    }

    public boolean isEnableSmartDispatchShortTask() {
        return enableSmartDispatchShortTask;
    }

    public void setEnableSmartDispatchShortTask(boolean enableSmartDispatchShortTask) {
        this.enableSmartDispatchShortTask = enableSmartDispatchShortTask;
    }
